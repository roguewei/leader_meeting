...
public class CodeMsg {
    ...
    public static CodeMsg QUERY_DATA_NUL = new CodeMsg(500118  , "没有查询到数据");
    ...
    // 参数模块5005XX
    public static CodeMsg PARAMETER_TRANSPORT_ERROR = new CodeMsg(500500, "参数转换错误");

    // Excel模块5006XX
    public static CodeMsg EXCEL_PARAMTER_ERROR = new CodeMsg(500600, "参数错误，请检查修改后重新上传");
