...
public class FileUtil {
    ...
    public Map<String, String> excuteUpload(MultipartFile file) throws FileNotFoundException {
        ...
        String substrnamestart = file.getOriginalFilename().substring(0, file.getOriginalFilename().lastIndexOf("."));
...
//        String filename = StringUtil.getRandomString(9) + substrname;
        String nowTime = TimeUtile.getTimeFormatDate(new Date().getTime());
        String filename = substrnamestart + nowTime + "-"+ StringUtil.getRandomString(3) + substrname;
...
//                length = VideoUtil.ReadVideoTimeMs(excelFile);
    ...
    /**
     * @auther: Winston
     * @Description: file转mul
     * @param:
     * @return:
     * @date: 2019/11/27 11:32
     */
    public MultipartFile transport(String filepath){
        File file = new File(filepath);
        MultipartFile multipartFile = null;
//        FileItemFactory factory = new DiskFileItemFactory(16, null);
//        FileItem item=factory.createItem(file.getName(),"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",true,file.getName());
