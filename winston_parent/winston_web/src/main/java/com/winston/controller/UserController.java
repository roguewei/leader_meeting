...
public class UserController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", value = "用户编号", required = true, dataType = "Long", paramType = "Long"),
            @ApiImplicitParam(name = "username", value = "用户名", required = false, dataType = "String", paramType = "String"),
            @ApiImplicitParam(name = "relName", value = "用户真实姓名", required = false, dataType = "String", paramType = "String"),
            @ApiImplicitParam(name = "sex", value = "用户邮箱", required = false, dataType = "String", paramType = "String"),
            @ApiImplicitParam(name = "nickName", value = "合同年度", required = false, dataType = "String", paramType = "String"),
            @ApiImplicitParam(name = "mobile", value = "用户邮箱", required = false, dataType = "String", paramType = "String"),
            @ApiImplicitParam(name = "enable", value = "保定开户id", required = false, dataType = "String", paramType = "String"),
            @ApiImplicitParam(name = "state", value = "保定开户名", required = false, dataType = "String", paramType = "String"),
    })
    @ApiResponses({
            @ApiResponse(code = 200, message = "成功请求", response = Result.class),
            @ApiResponse(code = 401, message = "无权限访问"),
